...
// }
  ...
  //     errors.lastname = 'Last name must be less than 10 character';
  //   }
  //   const telreg = /^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$/;
  //   const emailreg = /^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;
  //
  //   if(this.state.touched.telnum && !telreg.test(telnum)) {
  //     errors.telnum = 'Please enter valid phone number';
  //   }
...
// This is react form in this file we using react-redux-form
